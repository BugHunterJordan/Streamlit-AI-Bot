...
def game_step():
    ...
    with st.container():
        ...
        if lost_drive:
            ...
            # Show Roll button right under the output
            if st.button("🎲 Roll"):
                game_step()

# -----------------------------
# INITIAL ROLL BUTTON (BEFORE FIRST PLAY)
# -----------------------------
